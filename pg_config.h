...
#define PACKAGE_STRING "PostgreSQL 9.1.13"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "postgresql"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.1.13"
...
#define PG_VERSION "9.1.13"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 90113

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 9.1.13 on i686-pc-linux-gnu, compiled by gcc (Ubuntu/Linaro 4.8.1-10ubuntu9) 4.8.1, 32-bit"
