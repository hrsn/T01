...
${OBJECTDIR}/Tarea01-2S.o: Tarea01-2S.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tarea01-2S.o Tarea01-2S.cpp

${OBJECTDIR}/escibircsv.o: escibircsv.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/escibircsv.o escibircsv.c

${OBJECTDIR}/graficador.o: graficador.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graficador.o graficador.c
